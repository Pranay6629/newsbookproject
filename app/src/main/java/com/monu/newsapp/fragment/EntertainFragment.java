...
public class EntertainFragment extends Fragment {
    ...
    public static EntertainFragment getInstance(){
    ...
    public void onDetach() {
        super.onDetach();
//        EntertainFragment entertainFragment = new EntertainFragment();
////        getFragmentManager().beginTransaction().replace(R.id.viewPager, entertainFragment).commit();
//        Fragment fragment = getActivity().getSupportFragmentManager().findFragmentByTag(String.valueOf(entertainFragment));
//        if (fragment != null){
